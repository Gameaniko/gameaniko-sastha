...
class ArcballControl {
  ...
  get snapDirection() {
    return this.#snapDirection;
  }

  set snapTargetDirection(value) {
    this.#snapTargetDirection = value;
  }
}
...
class InfiniteGridMenu {
  ...
  #init(onInit) {
    ...
    this.#discProgram = createProgram(this.#gl, [discVertShaderSource, discFragShaderSource], null, {
      aModelPosition: 0,
      aModelNormal: 1,
      aModelUvs: 2,
      aInstanceMatrix: 3,
  ...
  #initBuffers() {
    ...
    gl.bufferData(gl.ARRAY_BUFFER, this.#discBuffers.vertices, gl.STATIC_DRAW);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, this.#discBuffers.uvs, gl.STATIC_DRAW);
  ...
  #render() {
    ...
    gl.uniform1f(this.#discLocations.uScaleFactor, 1.0);
...
export default function InfiniteMenu3D({ items = [] }) {
